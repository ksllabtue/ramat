...
%
% Changed to work with RaMAT, by Dmitri Visser, 27.09.2022
%
    ...
    % If no number of components is provided, use MATLAB default for PCA,
    % i.e. number of observations - 1.
    if isempty(a)
        a = obsCount - 1;
    end
    ...
    % Multiply variance by 100 for compatibility with MATLAB's built-in pca
    % function
    pcvar = pcvar*100;
end